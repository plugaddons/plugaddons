...
class Plugaddons_First_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'First Widget', 'plugaddons' );
	}
	...
	function register_content_controls() {
		...
		$this->add_control(
			'dummy_text',
			[
				'label'       => __( 'Dummy Text', 'plugaddons' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'input_type'  => 'text',
				'placeholder' => __( 'Some Dummy Text', 'plugaddons' ),
				'default'     => __( 'Elementor Blank Widget', 'plugaddons' ),
			]
		);
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => __( 'Text Style', 'plugaddons' ),
