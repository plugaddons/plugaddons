    ...
    $.fn.accordable = function(options) {
        ...
        */
        ...
        return this.each(function() {
            ...
            // cache variables
            var accordion = $(this),
                panel  	  = accordion.children('div.single-accordion'),
                heading   = panel.children('div.pla-accordion-title'),
                expander  = panel.children('div.pla-accordion-content');
            ...
            */
            ...
            if((defaults.openPanel.length > 0) && (defaults.openAll == false)) {
                ...
                panel.filter(filter).children('div.pla-accordion-content').show().parent().toggleClass('closed open');
                ...
                if(defaults.closeAll == true) {
                    ...
                    if($this.hasClass('open')) {
                        ...
                        // add and remove the proper classes
                            ...
                            // find the expander
                            .children('div.pla-accordion-content')
