...
class Plugaddons_Carousel_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_content_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .pla-skill' => 'color: {{VALUE}};',
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}}.pla-carousel span' => 'background-color: {{VALUE}};',
                ],
                'condition' => ['customize' => 'yes'],
                'style_transfer' => true,
            ]
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .pla-carousel span' => 'background-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        foreach ($settings['skills'] as $index => $skill) :
            ...
            ?>
            <div class="pla-carousel elementor-repeater-item-<?php echo $skill['_id']; ?>">
                <span class="skill-name"><?php echo $skill['name']?></span>
                <p><?php echo $skill['name_text']?></p>
            </div>
        <?php
        endforeach;
    }
